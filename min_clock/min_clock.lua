...
clock_table = {
   ...
   fill_color   = {0xFFA300, 1},       -- orange   -- fill color for minutes ring
   -- fill_color   = {0xA8028E, 1},    -- purple   -- fill color for minutes ring
   ...
   hour_font = "Inconsolata",  -- font face for hours
   min_font  = "Inconsolata",  -- font face for minutes
   day_font  = "Inconsolata",  -- font face for day and time period
