...
--guage DATA
 gauge = {
 {
    ...
    graph_unit_angle=2.7,          graph_unit_thickness=3.3,
...
function go_gauge_rings(display)
    ...
    local function load_gauge_rings_1(display, data)
        ...
        load_gauge_rings(display, gauge[2])
        load_gauge_rings(display, gauge[3])
        load_gauge_rings(display, gauge[4])
        load_gauge_rings_1(display, gauge[5])
